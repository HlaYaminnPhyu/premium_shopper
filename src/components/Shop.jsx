      ...
      <Breadcrumbs separator=">" mt="xs" className="tw-text-gray-500 tw-text-sm">{items}</Breadcrumbs>
              ...
              <div className="row tw-mb-12">
                <div className=" tw-flex tw-flex-wrap">
                  <div className=" d-flex tw-mb-3 justify-content-center align-items-center tw-px-2 tw-py-1 tw-bg-gray-100 tw-me-4">
                  ...
                  <div className=" d-flex justify-content-center align-items-center tw-px-4 tw-py-1 tw-bg-gray-100 tw-me-4">
                    <h2 className=" tw-me-4 tw-text-base tw-text-gray-500">
                      White
                    </h2>
                    <span className="">
                ...
                <div className="d-flex sm:tw-mt-6 tw-mt-4">
                  <div className="  d-flex justify-content-center align-items-center tw-p-4 tw-bg-gray-100 tw-me-4">
                    <h2 className=" tw-me-4 tw-text-base tw-text-gray-500">
                      $10.00 - $49.00
                    </h2>
